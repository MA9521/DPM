...
public class OdometerData {
  ...
  /**
   * Let other threads know that a reset peration is over.
   */
  private Condition doneReseting = lock.newCondition(); 
  
  /**
   * The single instance of this class. Initialized to null
   */
  private static OdometerData odoData = null;

  /**
   * Default constructor. The constructor is public. A factory is used instead such that only one
  ...
  /**
   * Return the current angle, between -180 and 180
